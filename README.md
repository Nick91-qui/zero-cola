...
| [PLANO_IMPL_FRONTEND.md](PLANO_IMPL_FRONTEND.md) | Plano de implementação do frontend, cobrindo portal, area academica, admin, tentativas e pendencias priorizadas. |
