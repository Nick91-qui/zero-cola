          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 p-4">
            <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
              ...
              <p className="mt-2 text-sm text-slate-600">
                ...
                <strong className="text-slate-900">{deletingTemplate.title || deletingTemplate.layout_version}</strong>.
              </p>
              <div className="mt-3 rounded-md bg-amber-50 border border-amber-200 p-3 text-xs text-amber-800">
                <strong>Preservação de Dados Acadêmicos:</strong> As notas, provas e imagens de cartões já corrigidos referentes a este gabarito <u>NÃO</u> serão apagadas do histórico dos alunos.
              </div>
